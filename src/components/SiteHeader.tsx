...
/**
 * Top-right login area. Server component: reads the session via `auth()` and
 * renders nothing when GitHub OAuth isn't configured, so the app degrades
 * cleanly without the AUTH_* env vars (matching the redis/turso/turnstile style).
 */
